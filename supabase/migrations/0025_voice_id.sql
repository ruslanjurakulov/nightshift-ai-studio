-- 0025: choose the ElevenLabs voice for a "Run now" on the queue.
--
-- The pipeline takes a per-run `voice_id` (an ElevenLabs voice id: 20 letters
-- and digits; config.ELEVENLABS_RUN_VOICE_ID). render_job_params_valid
